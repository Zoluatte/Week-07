...
```
method Main ไม่สามารถเข้าถึงตัวแปรจาก Class student ได้เพราะตัวแปรถูกเซตให้เป็น private
```
...
method Main สามารถเข้าถึงตัวแปรใน Class student ได้โดยใช้ properties
...
เปลี่ยนค่า GPA จาก 7.5 เป็น 3.5 ทำให้แสดงผลค่า GPA ได้
...
โปรแกรมทำการสร้าง method Student ให้ส่งค่าชนิด string Name, string ID โดย method Main จะกำหนดค่า string name, string ID
โดยกำหนดให้ string name = Student Name และ string ID = 123456789
...
Error เพราะ properties Name ไม่ได้สร้าง setter ไว้
...
class Program
    {
        static void Main(string[]args)
        {
            TraineeStudent TS = new TraineeStudent(15000,"61030000");
            Console.WriteLine("Student ID: " + TS.getID);
            Console.WriteLine("Student Salary: " + TS.getSalary);
            Console.ReadLine();
        }
    }
    class TraineeStudent
    {
        private int salary;
        private string ID;
        public TraineeStudent (int salary, string ID)
        {
            this.ID = ID;
            this.salary = salary;
        }
        public int getSalary { get { return salary; } }
