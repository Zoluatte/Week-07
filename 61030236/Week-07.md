...
![](images/04.PNG)
ภาพข้างบนจะได้ผลออกมา 


### สรุปผลการทดลอง
จากการที่ลองเปลี่ยนบรรทัด su.Name = "My name"; ออกไป จะเกิดการ error เพราะว่ามันเป็นแบบส่วนตัวจึงไม่สามรถเรียกใช้ได้
...
เกิดการ error เพราะว่า เราไม่ได้สร้างคลาสของ Teacher จึงไม่มีให้เรียกใช้
...
เราไม่ได้สร้างคลาสให้กับมันมันจึงเรียกใช้ไม่ได้
...
* อธิบายการทำงาน ตามที่เข้าใจ
จากการเขียน code ในส่วนของการเพิ่มเข้าไป จะได้ผลโปรแกรมออกมาที่คำเรียงต่อกัน
...
เป็นการเขียนโปรแกรมที่สร้างการเก็บค่าของตัวเเปรมาแล้วเอาค่าของแต่ละตัวแปรตามตำแหน่งที่ได้มา เเล้วเอามารวมกัน จะได้ค่าที่รวมกันออกมา มีการ หาค่าที่ติดลบโดยขอบเขตของมันไม่เกิน 9 เพราะว่าไม่เกิดค่าที่เราได้มา สิ้นสุดที่ -9
...
* อธิบายการทำงาน ตามที่เข้าใจ
เป้นการสืบทอดจากคลาสหลักตรงที่ว่าใช้โค้ดเดียวกันแล้วผลทที่ออกมาขึ้นอยู่กับการเขียนว่า ในประโยคนั้นเราใส่ keyword ของผลลัพธ์ว่าอะไร

* การประกาศแบบใด ที่ทำให้เกิด method overriding และ method hiding.
method overriding จะเกิดขึ้นกับเมธอดในคลาสเดียวกัน
method hiding
เป็นการดึงมาจากการที่เราเขียนเป็นการซ่อนข้อมูล
ซ่อนการทำงานบางอย่างเพื่อไม่ให้ Class อื่นเห็นการทำงาน โดยการกำหนดตวัแปรใน Class นั้น ให้เป็น private
...
```
![](images/121.PNG)
คลาสแม่ส่งผลถึงคลาสลูกจึงสามารถรันโปรแกรมได้ปกติ
...
```
เกิด error คลาส Student ไม่สามารถสร้างวัตถุใหม่ Professor ได้เพราะ Class Student ไม่ได้มี คลาส Professor เป็นคลาสลูก
...
```
เกิด error คลาส Teacher ไม่สามารถสร้างวัตถุใหม่ Person ได้เพราะ Class Teacher เป็นเพียงคลาสลูกเท่านั้น
