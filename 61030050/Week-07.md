...
*คลาส Student รับพารามิเตอร์ Name และ ID
-ทำให้สามารถกำหนดค่าเริ่มต้นให้วัตถุได้แล้วไม่สามารถแก้ไขภายหลังได้
 ``` 
...
```text
หาก propertiesภายใน คลาส เป็น pubic จะสามารถเข้าถึงข้อมูลได้อย่างอิสระแต่หาก
เป็น private จะต้องเพิ่ม properties get{} set{} 
ในการช่วยเข้าถึงข้อมูล
...
```text
สร้างวัตถุใหม่ชื่อ p แล้วสร้างเมธอด print 
เพื่อรับค่าพารามิเตอร์แต่ละค่าและสามารถเรียกใช้เมธอด print 
ในคลาสเดียวกันได้หลายอันของแต่ละค่าพารามิเตอร์
...
```text
สร้างวัตถุใหม่คือ v1,v2 โดยกำหนดค่าพารามิเตอร์ให้แล้ว สร้างคลาส Vector เพื่อรับค่าพารามิเตอร์
คือ x,y ทำการเซตค่าให้กับตัวแปร x,y สร้างเมธอดสำหรับทำให้ค่าที่ส่งกลับเป็นข้อความและ
สร้างเมธอดคำนวณค่าบวกกับลบแล้วส่งค่าที่ได้กลับไปแสดงผลเมื่อมีการเรียกใช้งาน
...
**อธิบายการทำงาน ตามที่เข้าใจ
 ```csharp
ในส่วนของ main จะมีการสร้างวัตถุใหม่จากคลาสแล้วเรียกใช้เมธอดจากแต่ละคลาสเพื่อแสดงผลตามลำดับ
ในส่วนของคลาส Person , Teacher และ Student
Class Person สร้าง เมธอดแบบ virtual เพื่อให้เมธอดคลาสอื่นสามารถ override ได้
Class Teacher สืบทอดมาจาก class person สร้างเมธอดแบบ override คือสามารถใช้ชื่อเมธอดซ้ำกับคลาส person ได้แต่การทำงานหรือการแสดงผลจะต่างกัน
Class Student สร้างเมธอดแบบ new() คือ การสร้างวัตถุใหม่ คือไม่ได้ override มาแต่เป็นการสร้างมาใหม่อีกอัน
...
ในส่วนของคลาส Person , Teacher และ Student
Class Person สร้าง เมธอดแบบ virtual เพื่อให้เมธอดคลาสอื่นสามารถ override ได้
Class Teacher สืบทอดมาจาก class person สร้างเมธอดแบบ override คือสามารถใช้ชื่อเมธอดซ้ำกับคลาส person
ได้แต่การทำงานหรือการแสดงผลจะต่างกัน
Class Student สร้างเมธอดแบบ new() คือ การสร้างวัตถุใหม่ คือไม่ได้ override มาแต่เป็นการสร้างมาใหม่อีกอัน
...
```textการประกาศแบบ polymorphism แบบ dynamic polymorphism และใช้งานร่วมกับการสืบทอดคุณสมบัติ

การประกาศแบบ polymorphism แบบ dynamic polymorphism และใช้งานร่วมกับการสืบทอดคุณสมบัติ
...
![](images/7.11.PNG)
```csharp
คลาส Person สามารถสร้างวัตถุใหม่ Professor ได้เพราะเป็นคลาสแม่จึงสามารถเข้าถึงคลาสลูกได้
คลาส Student ไม่สามารถสร้างวัตถุใหม่ Professor ได้เพราะ Class Student ไม่ได้มี คลาส Professor เป็นคลาสลูก
คลาส Teacher ไม่สามารถสร้างวัตถุใหม่ Person ได้เพราะ Class Teacher เป็นเพียงคลาสลูกเท่านั้น 
```
