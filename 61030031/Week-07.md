...
error เพราะ จากสาธรณะ เป็นส่วนตัวไม่ได้
...
error ไม่มีตัวแปลให้เรียกใช้งาน
...
ลบ // ด้านหน้า su.Name = "My name"; ออกไป จะเกิดerror
...
```text
error เพราะว่า เราไม่มีคลาสของ Teacher จึงไม่มีให้เรียกใช้
...
เป็นการสืบทอดสำหรับคลาส จึงเรียงกันได้
...
```text
 method overriding จะเกิดขึ้นกับเมธอดในคลาสเดียวกัน method hiding เป็นการดึงมาจากการที่เราเขียนเป็นการซ่อนข้อมูล ซ่อนการทำงานบางอย่างเพื่อไม่ให้ Class อื่นเห็นการทำงาน โดยการกำหนดตวัแปรใน Class นั้น ให้เป็น private
