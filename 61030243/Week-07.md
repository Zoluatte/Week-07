...
![Encapsulation](./images/การเข้าถึงfieldsแบบpublic.PNG)
...
Error เนื่องจากการทำ Ecapsulation แบบ Private คือการป้องกันไม่ให้สามารถเข้า fields ได้ ถ้าจะเข้าถึง fields ได้จะต้อง สร้าง constructer แล้วให้รับค่ามาใส่ใน field หรือ setter รับค่าผ่าน Properties ก็ได้
...
![Encapsulation](./images/การเข้าถึงfieldsผ่านทางproperties.PNG)
...
![Encapsulation](./images/การตรวจสอบความถูกต้องของข้อมูลโดยproperties.PNG)
...
![Encapsulation](./images/การตรวจสอบความถูกต้องของข้อมูลโดยpropertiesedit.PNG)
...
![](./images/การกำหนดวิธีการเข้าถึงข้อมูลภายในคลาส.PNG)
